...
resnet18.load_state_dict(torch.hub.load_state_dict_from_url('https://github.com/enilegna/General_Assembly_Projects/blob/main/Project_5/Capstone/Models/Resnet18-6/resnet18_epoch8.pth'))
